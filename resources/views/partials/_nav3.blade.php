<div class="bg-main-red py-2">
    <div class="main-container">
        <h1 class="text-2xl font-roboto font-bold text-white">
            ...
            <div id="categoriesDropdown"
                class="z-40 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-lg border-2 border-zinc-100 w-44 dark:bg-gray-700">
