    ...
    <div class="flex md:hidden">
        <div class="block md:hidden">
            <button data-collapse-toggle="navbar-search" type="button"
                class="inline-flex items-center justify-center w-10 h-10 p-2 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-hidden focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
            ...
            <div class="absolute hidden w-full -left-0" id="navbar-search">
                <form class="mt-4">
                    ...
                    <div class="relative">
                        ...
                        <button type="submit"
                            class="text-white absolute end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-hidden focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="block md:hidden">
            ...
            <div class="absolute hidden w-full -mt-2 z-500 -left-0" id="navbar-hamburger">
                <ul
                    class="flex flex-col mt-4 font-medium border-red-500 border-y-2 bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
                    <li>
                        <a href="#"
                            class="block px-3 py-2 text-gray-900 rounded-sm hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-main-red">Login</a>
                    </li>
                    <li>
                        <a href="#"
                            class="block px-3 py-2 text-gray-900 rounded-sm hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-main-red">Register</a>
                    </li>
                    <li>
                        <a href="#"
                            class="block px-3 py-2 text-gray-900 rounded-sm hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-main-red">Favorites</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="items-center hidden gap-4 md:flex">
        @guest
            <div>
                <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" data-dropdown-trigger="hover"
                    ...
                    <h1 class="flex flex-col text-left group-hover:text-main-red">
                        <span class="font-bold">{{ __('frontend.auth.login') }}</span>
                        <span class="font-thin">{{ __('frontend.auth.or-register') }}</span>
                    </h1>
                    <svg class="w-2.5 h-2.5 ms-3 group-hover:text-main-red" aria-hidden="true"
                ...
                <!-- Dropdown menu -->
                <div id="dropdown"
                    class="hidden bg-white divide-y divide-gray-100 rounded-lg shadow-lg z-31 w-44 dark:bg-gray-700">
                    <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownDefaultButton">
                        <li class="hover:text-main-red hover:underline">
                            <a href="{{ route('login') }}" class="block px-4 py-2">{{ __('frontend.auth.login') }}</a>
                        </li>
                        <li class="hover:text-main-red hover:underline">
                            <a href="{{ route('register') }}"
                                class="block px-4 py-2 ">{{ __('frontend.auth.register') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div>
            <a href="{{ route('auth.user.favorites') }}"
                ...
                <h1 class="group-hover:text-main-red">
                    ...
                    <ul class="pb-3 text-sm text-gray-700 " aria-labelledby="dropdownDefaultButton">
                        ...
                        <li>
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button class="hover:text-main-red! group py-1.5 px-3 inline-flex items-center gap-2"
                                    type="submit">
