                    ...
                    <section aria-labelledby="products-heading" class="pb-4 pt-6">
                        ...
                        <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                            ...
                            <form class="hidden lg:block ">
                              ...
                              <ul role="list"
                                ...
                                <div class="border-b border-gray-200 py-6" data-accordion="collapse" wire:ignore>
                                    <h3 class="-my-3 flow-root" id="accordion-category-collapse-heading">
                                        <button id="category-accordion-button" type="button"
                                            data-accordion-target="#accordion-category-collapse-body"
                                            class="flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500"
                                            aria-expanded="true" aria-controls="accordion-category-collapse-heading">
                                            <span class="font-medium text-gray-900">{{ __('frontend.category') }}</span>
                                            <span class="ml-6 flex items-center">
                                                <svg id="category-accordion-svg-plus" class="h-5 w-5"
                                                    viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                                    <path
                                                        d="M10.75 4.75a.75.75 0 00-1.5 0v4.5h-4.5a.75.75 0 000 1.5h4.5v4.5a.75.75 0 001.5 0v-4.5h4.5a.75.75 0 000-1.5h-4.5v-4.5z" />
                                                </svg>
                                                <svg id="category-accordion-svg-minus" class="hidden h-5 w-5"
                                                    viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                            ...
                            <div class="lg:col-span-3 grid grid-cols-3 gap-2  h-max">
                                {{-- <div class="col-span-3 grid grid-cols-3 animate-pulse">
                                  <div
                                      ...
                                      <div class="space-y-2">
                                          ...
                                          <div class="flex items-center justify-between ">
                                              <div class="h-5 bg-gray-200 rounded-full dark:bg-gray-700 w-36 mb-4">
                                              </div>
                                              <div class="h-5 bg-gray-200 rounded-full dark:bg-gray-700 w-36 mb-4">
                                              </div>
                                          </div>
...
@script
    <script>
        $("#category-accordion-button").on("click", function() {
            $("#category-accordion-svg-plus").toggleClass("hidden");
            $("#category-accordion-svg-minus").toggleClass("hidden");
        })
