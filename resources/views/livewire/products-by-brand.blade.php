                        ...
                        <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                            ...
                            <form class="hidden lg:block ">
                                <div class="py-6 border-b border-gray-200" data-accordion="collapse" wire:ignore>
                                    <h3 class="flow-root -my-3" id="accordion-category-collapse-heading">
                                        <button id="category-accordion-button" type="button" data-name="category"
                                            ...
                                            <span class="flex items-center ml-6">
                                                <svg id="category-accordion-svg-plus" class="hidden w-5 h-5"
                                                    viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                                    <path
                                                        d="M10.75 4.75a.75.75 0 00-1.5 0v4.5h-4.5a.75.75 0 000 1.5h4.5v4.5a.75.75 0 001.5 0v-4.5h4.5a.75.75 0 000-1.5h-4.5v-4.5z" />
                                                </svg>
                                                <svg id="category-accordion-svg-minus" class="w-5 h-5"
                                                    viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
