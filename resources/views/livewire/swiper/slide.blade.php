    ...
    <div class="space-y-2">
        ...
        <div class="flex items-center gap-2">
            ...
            @if ($product->review_count >= 1)
                <h3 class="text-xs font-thin">({{ number_format($product->review_rating_average, 1) }})</h3>
            @endif
        </div>
        <div class="flex flex-wrap items-end justify-between">
            ...
            <livewire:cart.add-to-cart-button :key="$prefix . $product->id" :productId="$product->id" :svg="false"
