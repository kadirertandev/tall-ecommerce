                        ...
                        <tbody>
                                    ...
                                    <td class="px-4 py-2">
                                        ...
                                        <div id="dropdownDots-{{ $admin->id }}" style="z-index: 8888"
                                            ...
                                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200 *:cursor-pointer"
                                                ...
                                                @can('edit admins')
                                                    <li wire:click='showEditModal({{ $admin->id }})'
                                                ...
                                                @endcan
                                                @can('assign role')
                                                    @if ($admin->role_name != 'owner' && $admin->role_name != $this->authRole)
                                                        <li id="assignRoleDropdownButton-{{ $admin->id }}"
                                                            data-dropdown-placement="left"
                                                            data-dropdown-toggle="assignRoleDropdown-{{ $admin->id }}"
                                                            class="flex items-center gap-1 px-4 py-2 hover:bg-cyan-500 group hover:text-white">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                class="w-4 h-4 text-gray-800 dark:text-white group-hover:text-white"
                                                                viewBox="0 0 32 32">
                                                            ...
                                                            <div id="assignRoleDropdown-{{ $admin->id }}"
                                                                ...
                                                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                                                    ...
                                                                    @foreach ($this->roles as $role)
                                                                        <li wire:click='assignRole({{ $admin->id }}, {{ $role->id }})'
                                                ...
                                                @else
                                                    @can('force delete admins')
                                                        <li wire:click='restore({{ $admin->id }})'
                            ...
                            @empty
                                <tr class="border-b border-gray-600 hover:bg-gray-100">
                                    <td colspan="9" class="text-2xl text-center text-thin">No admins
                                        found.</td>
                                </tr>
                            @endforelse
                        </tbody>
