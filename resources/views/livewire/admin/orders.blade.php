                        ...
                        <div class="flex flex-col flex-shrink-0 gap-2 md:flex-row md:items-center lg:justify-end">
                            ...
                            <div class="flex items-center justify-center">
                                <button id="dropdownDefault" data-dropdown-toggle="dropdown"
                                    ...
                                    class="flex items-center justify-center gap-1 px-4 py-2 text-sm font-medium text-white bg-teal-500 rounded-lg hover:bg-teal-600 focus:ring-4 focus:ring-primary-300 focus:outline-none"
                                    type="button">
