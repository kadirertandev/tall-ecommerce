    ...
    <main class="grid min-h-full px-6 py-24 bg-white place-items-center sm:py-32 lg:px-8">
        <div class="text-center">
            ...
            <div class="flex items-center justify-center mt-10 gap-x-6">
                <a href="{{ route('home') }}"
                    class="rounded-md bg-indigo-600 px-4 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500! focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">{{ __('frontend.errors.404.go-back-home') }}</a>
            </div>
        </div>
    </main>
