<section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
        ...
        <a href="{{ route('home') }}" class="text-4xl font-roboto main-red mx-auto mb-4">
        ...
        <h1
            ...
            Welcome, {{ $user->full_name() }}</h1>
        <a href="{{ route('home') }}" class="font-light text-gray-500 md:text-lg xl:text-xl dark:text-gray-400">Start
            shopping</a>
    </div>
</section>
